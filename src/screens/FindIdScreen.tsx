    ...
    <View className="flex-1 justify-center items-center bg-white px-[35px]">
      ...
      <View className='flex flex-col gap-[7px] items-center'>
        ...
        <View className='flex flex-row w-[289px] h-[44px]'>
            ...
            />
            <TouchableOpacity className={`${userName&&phoneNumber?"bg-[#3D47AA]":"bg-[#BABABA]"} w-[71px] h-[44px] py-3 rounded-xl mb-4`}
        ...
        <View className={`flex flex-row w-[289px] h-[44px]`}>
            ...
            />
            <TouchableOpacity className={`${authNumber.length>=6?"bg-[#3D47AA]":"bg-[#BCBCBC]"} w-[71px] h-[44px] py-3 rounded-xl mb-4`}
            onPress={async () => {
                try {
